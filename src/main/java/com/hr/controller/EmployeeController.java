...
public class EmployeeController {
    ...
    public EmployeeDTO crear(EmployeeDTO employeeDTO) throws MultipleException, EmailDuplicadoException {
    ...
    public EmployeeDTO editar(@PathVariable int id, EmployeeDTO employeeDTO) throws EmpleadoNoEncontradoException, MultipleException, EmailDuplicadoException {
